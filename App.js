...
import MyCustomMarkerView from './src/components/MyCustomMarkerView';
import MyCustomCalloutView from './src/components/MyCustomCalloutView';
...
export default class App extends React.Component {
  ...
  state = {
    ...
    x: 0,
    markerList: [
      {latlng: {latitude: 37.77825, longitude: -122.4224}, title: 'Title 1', description: 'Description 1'},
      {latlng: {latitude: 37.78825, longitude: -122.4324}, title: 'Title 2', description: 'Description 2'},
      {latlng: {latitude: 37.79825, longitude: -122.4424}, title: 'Title 3', description: 'Description 3'},
    ]    
  };
...
goToRegion = () => {   
  ...
  onRegionChange = (mapRegion) => {
    ...
    let d1 = Math.abs(this.state.currentRegion.latitude - mapRegion.latitude);
    let d2 = Math.abs(this.state.currentRegion.longitude - mapRegion.longitude);
